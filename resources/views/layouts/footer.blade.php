<footer class="bg-gray-100 dark:bg-[#18192a] border-t border-gray-200 dark:border-[#23243a] mt-16">
    <div class="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
        ...
        <div>
            ...
            <form class="flex flex-col gap-2" x-data="{ loading: false }" @submit.prevent="loading = true; setTimeout(() => loading = false, 1500)">
                ...
                <button type="submit" class="rounded py-2 bg-gradient-to-r from-purple-500 to-cyan-400 text-white font-semibold hover:from-purple-600 hover:to-cyan-500 transition flex items-center justify-center gap-2" :disabled="loading">
